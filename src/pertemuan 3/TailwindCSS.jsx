export default function TailwindCSS() {
  return (
    <div>
      <h1 class="px-2 border m-4">Belajar Tailwind CSS</h1>
...
function Typography(){
    return (
        <div>
            <h1 className=" px-4 text-3xl font-bold text-blue-600">Tailwind Typography</h1>
            <p className="px-4 text-gray-600 text-lg mt-2">Belajar Tailwind sangat menyenangkan dan cepat!</p>
        </div>
    )
}
